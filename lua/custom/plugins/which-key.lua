...
return {
  ...
  config = function()
    ...
    require("which-key").add({ -- group icons
      ...
      { "<leader>g", group = "[G]it", icon = { icon = "", color = "yellow" }, mode = "n" },
      { "<leader>g", group = "[G]it", icon = { icon = "", color = "yellow" }, mode = "v" },
    ...
    require("which-key").add({ -- icons in groups
      ...
      { "<leader>sr", icon = { icon = "󰍉", color = "yellow" } },
      ...
      { "<leader>xa", icon = { icon = "󰝑", color = "yellow" }, desc = "[A]dd todo" },
      { "<leader>xe", icon = { icon = "󱓥", color = "yellow" }, desc = "[E]dit todos" },
      ...
      { "<leader>cl", icon = { icon = "󰱺", color = "yellow" } },
      { "<leader>cu", icon = { icon = "", color = "yellow" } },
    })
